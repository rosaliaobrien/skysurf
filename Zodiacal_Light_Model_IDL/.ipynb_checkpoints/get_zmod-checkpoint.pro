...
;              
;---------------------------------------------------------------------
function get_zmod,lambda_str,day,lon,lat,zpar=zpar,no_colcorr=no_colcorr
...
;print,'1.25 params',[paramshg3[*,0],paramshg3[*,3]]
...
dbwave[0] = lambda
zkernel,data,zpar,z,no_colcorr=no_colcorr,dbwave=dbwave,losinfo=0
